...
successfull_classifier_agent = "Role: Evaluates overall productivity success based on goals and progress"
successfull_classifier_query = "Input: Goal classifier + Progress classifier outputs Output: {    success_score: float,  // 0-1 success rating    key_wins: [string],    key_challenges: [string],    trajectory: string  // 'improving', 'declining', 'stable' } Requirements: - Balance short vs long-term success metrics - Provide granular success decomposition - Identify critical success/failure factors"
